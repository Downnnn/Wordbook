package com.example.downn.wordbook;
...
public class Main2Activity extends AppCompatActivity {
            ...
            public void run() {
                ...
                if(transContent.equals("")||transContent==null)
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(Main2Activity.this,"输入为空",Toast.LENGTH_SHORT).show();
                            return;
                        }
                    });
    ...
    private void RefreshWordItemFragment() {
        WordItemFragment wordItemFragment = (WordItemFragment) getFragmentManager().findFragmentById(com.example.downn.wordbook.R.id.wordslist);
